...
namespace AimmyWPF
{
    public partial class MainWindow : Window
    {
        ...
        public MainWindow()
        {
            ...
            {
                System.Windows.MessageBox.Show("Visual C++ Redistributables x64 are not installed on this device, please install them before using D4RKWARE to avoid issues.", "Load Error");
        ...
        private void SetToggleState(AToggle toggle)
        {
            ...
            {
                System.Windows.MessageBox.Show("Select a character model before toggling.", "Toggle Error");
                return;
            }
        ...
        void LoadAimMenu()
        {
            AToggle Enable_AIAimAligner = new AToggle(this, "Enable Aimbot", 
                "Enables the aimbot.");
            ...
            AKeyChanger Change_KeyPress = new AKeyChanger("Change Aimbot Keybind", "Right");
            ...
            AToggle Show_FOV = new AToggle(this, "Show FOV Circle", 
                "Fov circle on local players screen. (custom colors soon)");
            ...
            ASlider MouseSensitivty = new ASlider(this, "Mouse Sensitivty", "Sensitivty",
                "Changes how fast the cursor moves to the player.",
                0.01);
        ...
        {
            AToggle Enable_TriggerBot = new AToggle(this, "Enable Trigger Bot",
                "Automatically shoot via seeing the player or pressing your key.");
            ...
            ASlider TriggerBot_Delay = new ASlider(this, "Trigger Bot Delay", "Seconds", 
                "How many miliseconds it takes before it presses again",
                0.1);
        ...
        void LoadSettingsMenu()
        {
            ...
            ASlider AIMinimumConfidence = new ASlider(this, "Confidence", "% Confidence", 
                "This setting controls how confident the aimbot needs to be before making the decision to aim.", 
                1);
